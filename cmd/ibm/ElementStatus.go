...
type IBM_TS4500 struct{}

func (IBM_TS4500) NewElementStatusPage(buffer []byte) _cmd.ElementStatusPage {
...
func (IBM_TS4500) NewDataTransferElementDescriptor(buffer []byte, page *_cmd.ElementStatusPage) _cmd.DataTransferElementDescriptor {
